...
public class DataBean {
    ...
    public static List<DataBean> getTestData() {
        ...
        list.add(new DataBean(R.drawable.img3, "极致简约,梦幻小屋", 3));
        list.add(new DataBean(R.drawable.img4, "极致简约,梦幻小屋", 3));
        list.add(new DataBean(R.drawable.img5, "极致简约,梦幻小屋", 3));
        return list;
    }
...
//    }
    ...
    public static List<DataBean> getTestDataVideo() {
        ...
        list.add(new DataBean(R.drawable.img1, "听风.赏雨", 1));
        list.add(new DataBean(R.drawable.img2, "迪丽热巴.迪力木拉提", 1));
        return list;
    }
