...
public class WalletDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Order order1 = new Order("河北天客隆",new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date(System.currentTimeMillis())),299.08, 10.40);
        Order order2 = new Order("河北天客隆",new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date(System.currentTimeMillis())),299.08, 10.40);
        Order order3 = new Order("河北天客隆",new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date(System.currentTimeMillis())),299.08, 10.40);
        wallets.add(order);
        wallets.add(order1);
        wallets.add(order2);
        wallets.add(order3);
